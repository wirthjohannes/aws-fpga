...
if {[string match *2020.2* [version -short]] || [string match *2021.* [version -short]] || [string match *2022.1* [version -short]]} {set_param project.replaceDontTouchWithKeepHierarchySoft false}
