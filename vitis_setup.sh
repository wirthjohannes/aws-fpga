...
if [[ $RELEASE_VER =~ .*2019\.2.*  ||  $RELEASE_VER =~ .*2020\.* ||  $RELEASE_VER =~ .*2021\.* ||  $RELEASE_VER =~ .*2022\.1.* ]]; then
   ...
   echo " $RELEASE_VER is not supported (2019.2, 2020.1, 2020.2, 2021.1, 2021.2 or 2022.1 are supported).\n"
   return 2
fi
